...
class MultiheadAttention(nn.Module):
    ...
    #     positional_encoding: Optional[Tensor] = None,
    # ) -> Tuple[Tensor, Optional[Tensor]]:
    ...
    #                 self.num_heads,
    #                 torch.empty([0]),
    #                 torch.cat((self.q_proj.bias, self.k_proj.bias, self.v_proj.bias)) if self.q_proj.bias else None,
    #                 self.bias_k,
    #                 self.bias_v,
    #                 self.add_zero_attn,
    ...
    def forward(
        ...
        return attn, attn_weights #, qkv_val

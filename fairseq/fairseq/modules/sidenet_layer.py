...
from fairseq.modules.joint_multihead_attention import JointMultiheadAttention
    ...
    *cfg.decoder.normalize_before* to ``True``.
    ...
    def forward(
        ...
        if external_memory is not None:
            # assert long_context_retrieval.requires_grad == False
            # long_context_retrieval = self.mapping(long_context_retrieval) if self.mapping else long_context_retrieval
            # if external_memory.index_list[0].ntotal == 0:
            if external_memory.dstore_idx == 0:
                ...
                # print("retrieval takes {:.4f} s".format(time.time() - retrieval_start))

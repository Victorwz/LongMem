...
from fairseq.models.sidenet import TransformerDecoderSideNet
...
@dataclass
class TransformerLanguageModelSideNetConfig(FairseqDataclass):
    ...
    reload_ptm_layer: Optional[bool] = field(
        default=False,
        metadata={
            "help": "Whether re-init the LM Head of GPT2 for side network",
        },
    )
...
@register_model("transformer_lm_sidenet", dataclass=TransformerLanguageModelSideNetConfig)
class TransformerLanguageModelSideNet(FairseqLanguageModel):
    @classmethod
    def hub_models(cls):
...
@register_model_architecture("transformer_lm_sidenet", "transformer_lm_sidenet_gpt_r_3")
def transformer_lm_gpt2_small(args):
    args.decoder_embed_dim = safe_getattr(args, "decoder_embed_dim", 256)
...
@register_model_architecture("transformer_lm_sidenet", "transformer_lm_sidenet_big")
...
@register_model_architecture("transformer_lm_sidenet", "transformer_lm_sidenet_wiki103")
@register_model_architecture("transformer_lm_sidenet", "transformer_lm_sidenet_baevski_wiki103")
...
@register_model_architecture("transformer_lm_sidenet", "transformer_lm_sidenet_gbw")
@register_model_architecture("transformer_lm_sidenet", "transformer_lm_sidenet_baevski_gbw")
...
@register_model_architecture("transformer_lm_sidenet", "transformer_lm_sidenet_gpt")
...
@register_model_architecture("transformer_lm_sidenet", "transformer_lm_sidenet_gpt2_base")
def transformer_lm_gpt(args):
    args.decoder_embed_dim = safe_getattr(args, "decoder_embed_dim", 768)
    args.decoder_ffn_embed_dim = safe_getattr(args, "decoder_ffn_embed_dim", 3072)
    args.decoder_layers = safe_getattr(args, "decoder_layers", 12)
...
@register_model_architecture("transformer_lm_sidenet", "transformer_lm_sidenet_gpt2_tiny")
...
@register_model_architecture("transformer_lm_sidenet", "transformer_lm_sidenet_gpt2_medium")
def transformer_lm_gpt2_medium(args):
    ...
    args.decoder_layers = safe_getattr(args, "decoder_layers", 18)
...
@register_model_architecture("transformer_lm_sidenet", "transformer_lm_sidenet_gpt2_big")
...
@register_model_architecture("transformer_lm_sidenet", "transformer_lm_sidenet_gpt2_big_wide")
...
@register_model_architecture("transformer_lm_sidenet", "transformer_lm_sidenet_gpt2_bigger")
...
@register_model_architecture("transformer_lm_sidenet", "transformer_lm_sidenet_gpt3_small")
...
@register_model_architecture("transformer_lm_sidenet", "transformer_lm_sidenet_gpt3_medium")
...
@register_model_architecture("transformer_lm_sidenet", "transformer_lm_sidenet_gpt3_large")
...
@register_model_architecture("transformer_lm_sidenet", "transformer_lm_sidenet_gpt3_xl")
...
@register_model_architecture("transformer_lm_sidenet", "transformer_lm_sidenet_gpt3_2_7")
...
@register_model_architecture("transformer_lm_sidenet", "transformer_lm_sidenet_gpt3_6_7")
...
@register_model_architecture("transformer_lm_sidenet", "transformer_lm_sidenet_gpt3_13")
...
@register_model_architecture("transformer_lm_sidenet", "transformer_lm_sidenet_gpt3_175")
